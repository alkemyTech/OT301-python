...
logging.basicConfig(level=logging.INFO,
                    ...
                    datefmt='%Y/%m/%d')
logging.info('Dag iniciado')               #Creamos el registro de que se inicio el dag
...
def transform():
    ...
    df['last_name'] = df['last_name'].str.lower().str.replace('_',' ')
    ...
    if len(df.fecha_nacimiento[0]) == 9:
    ...
    #Completo los datos faltantes de código postal y localidad
    if df.postal_code[0] == -1:

...
# create logger
logger = logging.getLogger("GGFLCSociales_dag_etl")
...
with DAG(
    ...
    task_1=DummyOperator(task_id='GGFLCSociales_getting_data_from_database')
    task_2=DummyOperator(task_id='GGFLCSociales_proc_with_pandas')
    task_3=DummyOperator(task_id='GGFLCSociales_load_data_in_S3')
